...
window.addEventListener('DOMContentLoaded', () => {{
    ...
    out_dir = WORKSPACE / "tools/inspect_kid"
    ...
    with sync_playwright() as p:
        ...
        for i in range(1, 15):
            ...
            (WORKSPACE / "tools/temp_kid.html").write_text(html_tpl.format(swf_url=swf_rel), encoding="utf-8")
            page.goto(f"http://127.0.0.1:{PORT}/tools/temp_kid.html")
