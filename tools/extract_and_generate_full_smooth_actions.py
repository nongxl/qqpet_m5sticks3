...
def generate_micro_and_weather_actions():
    print("\n--- Generating high-frame smooth micro, weather and hospital actions ---")
    for gender in ["MM", "GG"]:
...
def main():
    print("==========================================================")
    print("Starting Official Full-Frame Action Extraction & Pipeline")
    print("==========================================================")
    ...
    with sync_playwright() as p:
        ...
        for stage, actions in ACTION_CONFIG.items():
            for gender in ["GG", "MM"]:
                print(f"\n>>> Extracting SWF animations for {gender}/{stage} ({len(actions)} actions)...")
    ...
    # 生成高帧率、平滑连贯的专属生活微动作
    generate_micro_and_weather_actions()

    print("\n==========================================================")
    print("All actions extracted and generated successfully!")
    print("==========================================================")
